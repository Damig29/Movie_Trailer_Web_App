...
const Header = ({ movieInfo }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 p-5 sm:p-10 w-full min-h-[40vh] sm:min-h-0 sm:flex-row sm:items-start sm:justify-between sm:space-x-10">
            <div className="flex flex-col items-center sm:items-start">
                <h1 className="text-2xl sm:text-4xl font-bold text-center sm:text-left">{movieInfo?.title || 'Unknown Title'}</h1>
                <div className="flex gap-2 text-gray-100 mt-4 sm:mt-0 justify-center sm:justify-start">
            ...
            <div className='flex text-gray-100 gap-3 mt-4 sm:mt-0 justify-center sm:justify-end'>
                <div className='flex bg-indigo-950 h-10 whitespace-nowrap flex-shrink-0 rounded-md items-center p-2'>
